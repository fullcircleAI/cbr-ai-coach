...
export const tramInteractionsQuestions: Question[] = [
  {
    ...
    explanation: 'Trams have priority over other vehicles.',
  ...
  },
  {
    ...
    explanation: 'When a tram is stopped at a tram stop.',
    subject: 'Tram Interactions'
  },
  {
    id: 'q-ti-3',
    ...
    explanation: 'Trams have priority at intersections and crossings.',
    subject: 'Tram Interactions'
  },
  {
    id: 'q-ti-4',
    ...
    explanation: 'When driving on roads with tram tracks.',
    subject: 'Tram Interactions'
  },
  {
    id: 'q-ti-5',
    ...
    explanation: 'Trams with flashing lights have priority and may be making an emergency stop.',
    subject: 'Tram Interactions'
  },
  {
    id: 'q-ti-6',
    ...
    explanation: 'When a tram is approaching from the opposite direction.',
    subject: 'Tram Interactions'
  },
  {
    id: 'q-ti-7',
    ...
    explanation: 'Trams have priority when making turns.',
    subject: 'Tram Interactions'
  },
  {
    id: 'q-ti-8',
    ...
    explanation: 'When a tram is at a stop with passengers boarding.',
    subject: 'Tram Interactions'
  },
  {
    id: 'q-ti-9',
    ...
    explanation: 'When a tram has its doors open, it means passengers are boarding or alighting.',
    subject: 'Tram Interactions'
  },
  {
    id: 'q-ti-10',
    ...
    explanation: 'Trams with red lights have priority and may be making an emergency stop.',
    subject: 'Tram Interactions'
  }
];
